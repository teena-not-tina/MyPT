...
@detection_router.get("/api/detect/performance")
    ...
    try:
        ...
        return {
            ...
            "performance_features": [
                ...
                "Vegetable-specific analysis",
                "OCR integration"
            ],
            "optimization_tips": [
                "Use confidence >= 0.5 for better accuracy",
                "Enable ensemble for best results",
                "OCR text improves brand recognition"
            ]
        }
    except Exception as e:
